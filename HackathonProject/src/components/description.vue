...
<g>
	<g>
		...
		<path d="M3.782,14.884v0.696c0.243-0.568,0.511-1.122,0.798-1.665L3.782,14.884z"/>
            ...
            <!-- Logo -->
            <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 48.625 48.625"></svg>
          </div>
...
<!--             
            ...
            <p class="mt-4  text-lg text-gray-400">
              Explore the intriguing world of Near-Earth Objects (NEOs) and asteroids. Learn how they move through space, their potential impact on Earth, and test your knowledge with a quick quiz. Ready to explore the cosmos?        </p> -->
                <p class="mt-4 mb-8 text-2xl text-gray-400">
                  After all your exploration of our universe, it's time to put your knowledge to the test. Are you ready?
                </p>
                <div class="py-5 bg-white rounded-lg shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_15px_#08f,0_0_30px_#08f]">
                <details class="group">
                    <summary class="flex cursor-pointer list-none items-center justify-between font-medium">
                       <span class="text-2xl ml-5"> Click <spam class="text-blue-500">here </spam>to begin your quiz!</span>
    ...
    <div class="sm:w-1/2 p-10">
        <div class="image object-center text-center">
            <img src="../assets/images/dcc.jpg">
        </div>
    </div>
    <div class="sm:w-1/2 p-5 mb-0">
        <div class="text">
            <span class="text-gray-500 border-b-2 border-blue-500 uppercase">About us</span>
            <h2 class="my-4 font-bold text-3xl  sm:text-4xl ">About <span class="text-blue-500">Web Site</span>
            </h2>
            <p class="text-gray-700">
              Welcome to our website, where the mysteries of the universe come alive! Explore the vastness of space, learn about Near-Earth Objects (NEOs) and asteroids, and dive deep into the wonders of our solar system. Whether you're here to expand your knowledge or test what you know with our engaging quizzes, this is your gateway to discovering the cosmos like never before. Join us on this cosmic adventure!
            </p> 
        </div>
