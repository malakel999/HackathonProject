...
.quiz-container {
  background: url('../assets/images/starry_background.jpg') no-repeat center center fixed;
...
.quiz-question {
  margin-bottom: 20px;
  text-align: left; /* Ensure question text aligns to the left */
}
...
.option-container {
  ...
  cursor: pointer;
  text-align: left; /* Ensures options align to the left */
}
